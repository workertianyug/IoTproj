...
class App:
	...
	def update(self):
		...
		# receive coach mouse pos
		coach_mouse_x, coach_mouse_y, self.data["coachText"] = self.image_hub.recv_pos()
		self.data["coachMousePos"][0] = coach_mouse_x
		self.data["coachMousePos"][1] = coach_mouse_y
